...
def get_sorted_file_paths(directory):
    ...
    # 按文件名中的数字排序（例如 "1.jpg" < "2.jpg" < "10.jpg"）
...
config_path         = "/home/zhangjiaju/deeplearning/VideoX-Fun/config/wan2.1/wan_civitai.yaml"
# model path
model_name          = "/home/zhangjiaju/deeplearning/VideoX-Fun/models/Wan2.1-Fun-V1.1-14B-Control"
...
control_video_path           = "/home/zhangjiaju/deeplearning/VideoX-Fun/test/test_video_douyin/control_video"
control_videos = get_sorted_file_paths(control_video_path)

control_camera_txt      = None
start_image             = None
ref_image_path               = "/home/zhangjiaju/deeplearning/VideoX-Fun/test/test_video_douyin/ref_image"
ref_images = get_sorted_file_paths(ref_image_path)
...
prompt_path = '/home/zhangjiaju/deeplearning/VideoX-Fun/test/test_video_douyin/caption.txt'
prompts = read_txt_to_list(prompt_path)
...
lora_weight             = 0.55
save_path               = "/home/zhangjiaju/deeplearning/VideoX-Fun/test/test_video_douyin/output_14B"
...
for i in tqdm(range(len(ref_images))):
    ...
    prompt = prompts[i]
    control_video = control_videos[i]
    with torch.no_grad():
